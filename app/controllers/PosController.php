...
class PosController extends \BaseController {
	...
	public function index()
	{
    	...
    	$products = Product::join('prices',"product_id","=",'products.id')
...
//print_r($input);	    	return ;	 
	...
	{
		return Response::json(array('version'=> '3.9.5'));
	}
	...
	public function guardarFactura()
    {
		...
		//guardando en el backup de servidor de ventas
		// $backup = array();
		// array_push($backup, $this->completeFields(Input::all()));   
